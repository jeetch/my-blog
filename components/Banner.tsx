  ...
  return (
    <div className="relative flex-col sm:flex sm:flex-row gap-2 w-full items-center z-10 shadow-sm text-left  py-16 sm:py-12 px-4 sm:px-12 ">
      ...
      <div className="flex w-full sm:w-2/3 flex-col">
        ...
        >
          Also, currently MBA Candidate at McCombs School of Business, University of Texas at Austin 🤘 Love data, design and code 👨‍💻 Data Scientist with 5+ years of experience in healthcare consulting 💼 Currently mastering jumprope and calisthenics 🤸‍♂️
        </motion.div>
      </div>
    </div>
  );
